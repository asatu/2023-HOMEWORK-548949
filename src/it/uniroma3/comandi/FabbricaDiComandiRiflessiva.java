...
public class FabbricaDiComandiRiflessiva implements FabbricaDiComandi {
	...
	public AbstractComando costruisciComando(String istruzione, IO io) {
		...
		StringBuilder nomeClasse = new StringBuilder("it.uniroma3.comandi.Comando");
		try {
			nomeClasse.append( Character.toUpperCase(nomeComando.charAt(0)) );
			// es. nomeClasse: ‘it.uniroma3.comandi.ComandoV’
			nomeClasse.append( nomeComando.substring(1) ) ;
			// es. nomeClasse: ‘it.uniroma3.comandi.ComandoVai’
