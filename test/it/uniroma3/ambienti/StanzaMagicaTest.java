...
public class StanzaMagicaTest {
	...
	public void testAddAttrezzoOltreSogliaMagica() {
		for (int i = 0; i < SOGLIA_MAGICA; i++) 
			this.stanzaMagicaTest.addAttrezzo(new Attrezzo(ATTREZZO_TEST, 1));
		this.stanzaMagicaTest.addAttrezzo(new Attrezzo(ATTREZZO_DA_MODIFICARE, 1));
	...
	public void testAddAttrezzoSingolo() {
		Attrezzo test = new Attrezzo(ATTREZZO_TEST, 1);
		this.stanzaMagicaTest.addAttrezzo(test);
		assertEquals(test, this.stanzaMagicaTest.getAttrezzo(ATTREZZO_TEST));
	}
}